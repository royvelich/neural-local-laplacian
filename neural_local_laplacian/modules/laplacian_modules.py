...
class LaplacianTransformerModule(LaplacianModuleBase):
    ...
    def __init__(self,
                 ...
                 area_bound_C: float = 4.0 * 3.14159265,
        ...
        # Activation is applied manually via _apply_area_activation (softplus or bounded_sigmoid)
    ...
    def forward_fixed_k(self, batch: Batch) -> Dict[str, torch.Tensor]:
        ...
        # Area head outputs raw logits; activation applied separately
        areas_raw = self.area_head(pooled_features).squeeze(-1)  # (batch_size,)
